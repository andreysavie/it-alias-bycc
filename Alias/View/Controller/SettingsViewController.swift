...
class SettingsViewController: UIViewController {
    ...
    @objc func teamOneAction() {
        let alert = UIAlertController(title: "Name of first team", message: "enter the name of first team", preferredStyle: .alert)
    ...
    @objc func teamTwoAction() {
        let alert = UIAlertController(title: "Name of second team", message: "enter the name of second team", preferredStyle: .alert)
        alert.addTextField { (textField) in
